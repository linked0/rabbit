...
**Scenarios**
- *Personal:* a research/purchase agent auto-pays USDC per paid API call; the user sets only policy
...
- **rabbit-provider** — sells **philosophical aphorisms** for **0.01 USDC** (or a stablecoin) to AI
...
- Choose wallet / chain / stablecoin (assume **Base + USDC**).
...
- [ ] **rabbit-aiaas (Agent-as-a-Service)** — separate project `/Users/jay/work/task/rabbit-aiaas`
  - [ ] **rabbit-provider** — testnet service selling aphorisms for 0.01 USDC via x402 402-flow; design for real rails
