...
## Contents
- [getting-started.md](getting-started.md) — clone, install, run, test
...
- [task-workflow.md](task-workflow.md) — task → plan → build → history cycle

## Principles
- **Keep docs short and living** — a stale guide is worse than none. Date and prune them.
- **Codify with tooling** where possible (formatters, linters, CI) — the doc explains
  *why*, the tooling enforces *what*.
