...
const PAGE_CSS = `
  ...
  * { box-sizing: border-box; }
  ...
  /* inline-block + 세로 패딩을 조금 더 (jay, 2026-09-11) — 인라인이라 파란 배지보다 낮게 보이던
     상자를 배지와 비슷한(살짝 더 높은) 높이로 맞춘다. */
  .rail-note-pink { color:#ec4899; background:rgba(236,72,153,0.14); display:inline-block; padding:3px 8px; }
